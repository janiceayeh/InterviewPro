...
const categories = [
  {
    id: 'behavioral',
    title: 'Behavioral',
    description: 'Questions about your past experiences and how you handled situations',
    icon: Users,
    questionCount: 10,
    duration: '15 min',
  ...
  },
  {
    id: 'situational',
    title: 'Situational',
    description: 'Hypothetical scenarios to evaluate your decision-making skills',
    icon: Target,
    questionCount: 8,
    duration: '15 min',
  ...
  },
  {
    id: 'general',
    title: 'General',
    description: 'Common interview questions every candidate should prepare for',
    icon: Briefcase,
    questionCount: 12,
    duration: '20 min',
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-medium text-primary">Mock Interview Prep</span>
        </div>
        <h1 className="text-3xl font-bold text-foreground mb-2">Choose Your Interview Type</h1>
        <p className="text-muted-foreground max-w-2xl">
          Select a category to begin your timed mock interview. Each question has a countdown timer
      ...
      >
        <Link
          href={selectedCategory ? `/dashboard/mock-interview/${selectedCategory}` : '#'}
      ...
      >
        ...
        <ol className="space-y-3 text-muted-foreground">
          <li className="flex items-start gap-3">
            ...
            <span>Select a category that matches your interview preparation needs</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex items-center justify-center size-6 rounded-full bg-primary/10 text-primary text-sm font-medium flex-shrink-0">
              2
            </span>
            <span>Answer each question within the time limit - the timer simulates real pressure</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex items-center justify-center size-6 rounded-full bg-primary/10 text-primary text-sm font-medium flex-shrink-0">
              3
            </span>
            <span>Our AI analyzes your responses and provides detailed feedback</span>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex items-center justify-center size-6 rounded-full bg-primary/10 text-primary text-sm font-medium flex-shrink-0">
              4
            </span>
            <span>Review your performance report with personalized improvement tips</span>
          </li>
        </ol>
      </motion.div>
    </div>
